...
\link[\LaTeX]{http://texlive.org}\ and
\link[\sf git]{http://git-scm.com} these programs are necessary
to take full advantage of the features of the 
\link[\sf Ximera]{http://ximera.osu.edu} system.
