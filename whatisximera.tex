...
\begin{center}
\includegraphics[width=7.5in]{XimeraGraphic.png}
\end{center}
...
While an activity on an LSM consists solely of a sequence of problems, a \link[\sf Ximera]{http://ximera.osu.edu}
