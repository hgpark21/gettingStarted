...
\begin{remark}
({\bfseries Note}: To get started by setting up a GitHub acoount, \link[\sf click here]{http://497a6980.ngrok.com/course/hgpark21/gettingStarted2/master/gettingstarted2}.)
%%%% Chage the link later %%%%%
\end{remark}

\link[\sf Ximera]{http://ximera.osu.edu} is an open-source software project that seeks to help course instructors create learning materials for their students in the form of interactive web pages and high quality PDF documents.
...
Next the author uploads the same \LaTeX\ file to \link[\tt github.com]{http://github.com},
a free web-based service providing a number of features to developers and authors.
In turn \link[\tt github.com]{http://github.com} delivers the file to the \link[\sf Ximera]{http://ximera.osu.edu} interpreter, which posts the file on the web.
...
One benefit of \link[\sf Ximera]{http://ximera.osu.edu} is that it provides an easy way to produce interactive online materials.
...
And because the \TeX\ language is extremely static in comparison with other programming and markup languages, authors can expect the \link[\sf Ximera]{http://ximera.osu.edu} materials they create to be usable in some form for the foreseeable future.
...
The function of an LMS most relevant to our discussion of \link[\sf Ximera]{http://ximera.osu.edu} is assessment.
...
In contrast \link[\sf Ximera]{http://ximera.osu.edu} provides a more flexible environment for creating course materials.
While an activity on an LMS consists solely of a sequence of problems, a \link[\sf Ximera]{http://ximera.osu.edu}
...
For example, a course could consist of a sequence of \link[\sf Ximera]{http://ximera.osu.edu} activities, each of which primarily composed of text for students to read, with an occasional question sprinkled in to confirm and deepen students'
...
Another possibility is to use \link[\sf Ximera]{http://ximera.osu.edu} in conjunction with a traditional lecture-based course,
using \link[\sf Ximera]{http://ximera.osu.edu} to deliver pre-lecture reading materials and exercises to be completed by students before arriving to their lecture.
...
The emphasis of \link[\sf Ximera]{http://ximera.osu.edu} is more on content delivery than on assessment.
We understand however that many students function better knowing that their actions will be acknowledged by their instructors. We therefore envisage providing ways for instructors to access student scores on \link[\sf Ximera]{http://ximera.osu.edu} activities in the near future. In the meantime it might be better to use a traditional LMS to deliver exercises
