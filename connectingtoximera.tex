...
\item\textbf{Step 1.} Go to \link[\sf Ximera]{http://ximera.osu.edu} and sign in with your Google account.

\item\textbf{Step 2.} Connect \textbf{Ximera} to your \textbf{GitHub}: 
...
\item\textbf{Step 3.} 
 Click \textbf{Settings} botton on your \texttt{github.com} repository and then \textbf{Webhooks \& Services}. 
...
\item\textbf{Step 5.} Saving your work in the GitHub repository is called \textbf{committing}; 
after pasting the above code, scroll down and click the \textbf{Commit new file} button.

\item\textbf{Step 6.} Saving your work in the GitHub repository is called \textbf{committing}. 
...
\item\textbf{Step 7.} Once you see the green checkmark in the branch listing, 
